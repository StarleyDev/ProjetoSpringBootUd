...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Produto p7 = new Produto(null, "TV 60 Polegadas", 1800.00);
		Produto p8 = new Produto(null, "Roçadeira", 800.00);
		Produto p9 = new Produto(null, "Abajour", 20.00);
		Produto p10 = new Produto(null, "Pendente", 180.00);
		Produto p11 = new Produto(null, "Shampoo", 22.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "starlleycom@gmail.com", "36378912377", TipoCliente.PESSOAFISICA);
